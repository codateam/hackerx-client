      ...
      <div className="flex flex-col md:flex-row gap-6 lg:gap-10">
        <div className="w-full md:w-2/3">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <MetricCard title="Total Students" value="10" bgColor="#FF5656" />
            <MetricCard title="Active Courses" value="5" bgColor="#32BA77" />
            <MetricCard
          ...
          <div className="flex flex-col gap-4 bg-white p-4 lg:p-6 rounded-lg">
            ...
            <div className="mb-2">
              ...
              >
                ...
                <CourseItem
                    courseCode="CSC 422"
                    courseTitle="Data Communication and Network"
                  />
                  <CourseItem
                    courseCode="CSC 420"
